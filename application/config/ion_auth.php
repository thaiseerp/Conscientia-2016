 ...
 */
$config['site_title']                 = "conscientia.co.in";         // Site Title, example.com
$config['admin_email']                = "support@conscientia.co.in"; // Admin Email, admin@example.com
$config['default_group']              = 'members';                   // Default group, use name
$config['admin_group']                = 'admin';                     // Default administrators group, use name
$config['banned_group']                = 'banned';                   // Default administrators group, use name
$config['evadmin_group']                = 'evadmin';         // Default eventadmin group, use name
$config['wsadmin_group']                = 'wsadmin';         // Default workshop admin group, use name
$config['hsadmin_group']                = 'hsadmin';         // Default hospitality admin group, use name
