<div class="containter" id="arena" style="padding:10px 15px 100px 0px;">
	<div class="row">
		<div class="col-md-8 col-md-offset-2 text-center" id="level">
			<h3 style="color:#fff">Question 5
               <br />
               <br />
                <img src="<?=base_url()?>contents/events/mathematrix/level_5.jpg">
            </h3>
		</div>
	</div>
	<div class="row">
		<div class="col-lg-4 col-lg-offset-4">
			...
			<div class="input-group input-group-lg">
				...
				<?php
                switch ($this->math_levels_model->get_attempts(5)) {
                    case '0':
