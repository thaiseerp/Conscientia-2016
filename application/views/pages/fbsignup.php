...
<ol class="fs-fields">
	...
	<li>
	<label class="fs-field-label fs-anim-upper" for="q2" data-info="We won't send you any spam">What's your email address?</label>
    ...
    <li data-input-trigger>
        <label class="fs-field-label fs-anim-upper" for="q3" data-info="Our hospitality team will contact you for more details">Do you need accomodation?</label>
		<div class="fs-radio-group fs-radio-custom clearfix fs-anim-lower">
		  <span>
            <?php 
            $accomodation = array(
