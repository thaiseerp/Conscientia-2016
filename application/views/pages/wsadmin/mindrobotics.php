...
<html>
<head>
<title>Conscientia 2016 | Workshop Admin Page</title>
...
<div class="info" >
		...
		$cos='';
        $i=1;
        if(!empty($mindrobotics))
        {
            foreach($mindrobotics as $row){
				$cos.="<tr>";
				$cos.="<td>".$i."</td>";
				$cos.="<td>".$row['name']."</td>";
				$cos.="<td>".$row['email']."</td>";
    ...
    <table>
        <tr>
            <th colspan="5" style="color:#A48CFF;margin-bottom:100px">Mind controlled Robotics</th>
        </tr>
        <tr>
            <th>Id</th>
            <th>Name</th>
