...
<div class="info" >
        ...
        if(!empty($electromania))
        {
            foreach($electromania as $row){
				$night.="<tr>";
				$night.="<td>".$k."</td>";
    ...
    <table>
        <tr>
            <th colspan="5" style="color:#A48CFF">LCD</th>
        </tr>
        <tr>
            <th>Id</th>
            <th>Name</th>
    ...
    <table>
        <tr>
            <th colspan="5" style="color:#A48CFF">Circuiter</th>
        </tr>
        <tr>
            <th>Id</th>
            <th>Name</th>
    ...
    <table>
        <tr>
            <th colspan="5" style="color:#A48CFF">Electromania</th>
        </tr>
        <tr>
            <th>Id</th>
            <th>Name</th>
    ...
    <table style="margin-bottom:100px">
        <tr>
            <th colspan="5" style="color:#A48CFF">Tarang</th>
        </tr>
        <tr>
            <th>Id</th>
            <th>Name</th>
