...
<div class="info" >
        ...
        $abc='';
        $i=$j=$k=$l=1;
        if(!empty($cosmicclash))
        {
            foreach($cosmicclash as $row){
				$cos.="<tr>";
				$cos.="<td>".$i."</td>";
				$cos.="<td>".$row['name']."</td>";
				$cos.="<td>".$row['email']."</td>";
        ...
        if(!empty($astroreflections))
        {
            foreach($astroreflections as $row){
				$astro.="<tr>";
				$astro.="<td>".$j."</td>";
        ...
        if(!empty($nightskyhunt))
        {
            foreach($nightskyhunt as $row){
				$night.="<tr>";
				$night.="<td>".$k."</td>";
    ...
    <table>
        <tr>
            <th colspan="5" style="color:#A48CFF">Cosmic Clash</th>
        </tr>
        <tr>
            <th>Id</th>
            <th>Name</th>
    ...
    <table>
        <tr>
            <th colspan="5" style="color:#A48CFF">Astroreflections</th>
        </tr>
        <tr>
            <th>Id</th>
            <th>Name</th>
    ...
    <table>
        <tr>
            <th colspan="5" style="color:#A48CFF">Night Sky Hunt</th>
        </tr>
        <tr>
            <th>Id</th>
            <th>Name</th>
    ...
    <table style="margin-bottom:100px">
        <tr>
            <th colspan="5" style="color:#A48CFF">Astro ABC</th>
        </tr>
        <tr>
            <th>Id</th>
            <th>Name</th>
