...
<div class="container">
	<div class="row">
		<div class="col-lg-4 col-lg-offset-4">
			...
			<a href="<?=base_url()?>astroadmin/levels/add_level" class="btn btn-warning">Add New Level</a>
			<hr>
					...
					if($levels!=NULL && count($levels)){
						foreach($levels as $row){
							...
							echo "<tr>";
								...
								echo '<td><a href="'.base_url().'astroadmin/levels/status/?level='.$row['level'].'&now='.$status.'" class="btn '.$button_class[$status].'">'.$button[$status].'</a></td>';
							echo "</tr>";
						}
					}
			...
			<hr>
			<form class="form-inline" role="form" action="<?=base_url()?>astroadmin/levels/set_user" method="post">
