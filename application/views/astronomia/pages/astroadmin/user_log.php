...
<div class="container">
	<div class="row">
		<div class="col-md-12">
			...
			<a href="<?=base_url()?>astroadmin/users" class="btn btn-info"><i class="glyphicon glyphicon-chevron-left"></i> Back to users</a>
			...
			<?php if($user_log){ 
				...
				?>
			<h3>Username: <span class="text-muted"><?=$user_log[0]['name'];?></span></h3>
			<?php }?>
