...
<head>
	...
	<meta property="og:title" content="Conscientia 2016 | Astronomia">
	<meta property="og:type" content="Astronomia">
	<meta property="og:url" content="http://www.conscientia.co.in/">
	<meta property="og:description" content="An exciting online astronomy treasure hunt !">
...
<body>
        ...
        <header class="header1" role="banner">
	      ...
	      <ul class="nav navbar-nav">
	        ...
	        <li><a href="<?=base_url();?>astronomia">Arena</a></li>
	        <?php } ?>
	        <li><a href="<?=base_url();?>astronomia/rules">Rules</a></li>
	        <li><a href="<?=base_url();?>astronomia/leaderboard">Leaderboard</a></li>
</ul>
