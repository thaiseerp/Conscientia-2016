            ...
            <div id="inner-footer" class="wrap clearfix">
                <div class="explore" style="border-bottom:1px solid #616A7A;margin-bottom:10px">
                    ...
                    <ul style="margin-left:-50px;">
                        ...
                        <li style="display: inline;"><a href="<?=base_url()?>webbed/">Arena</a></li>
                        <?php } ?>
                        <li style="display: inline;"><a href="<?=base_url()?>webbed/rules/">Rules</a></li>
                        <li style="display: inline;"><a href="<?=base_url()?>webbed/leaderboard/">Leaderboard</a></li>
                    </ul>
